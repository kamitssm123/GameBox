...
background_surface = pygame.image.load('flappybird/assets/background-day.png').convert()
background_surface = pygame.transform.scale2x(background_surface)

floor_surface = pygame.image.load('flappybird/assets/base.png').convert()
floor_surface = pygame.transform.scale2x(floor_surface)
floor_x_position = 0

bird_downflap = pygame.transform.scale2x(pygame.image.load('flappybird/assets/bluebird-midflap.png').convert_alpha())
bird_midflap = pygame.transform.scale2x(pygame.image.load('flappybird/assets/bluebird-midflap.png').convert_alpha())
bird_upflap = pygame.transform.scale2x(pygame.image.load('flappybird/assets/bluebird-midflap.png').convert_alpha())
...
pipe_surface = pygame.image.load('flappybird/assets/pipe-green.png')
...
game_over_surface = pygame.transform.scale2x(pygame.image.load('flappybird/assets/message.png').convert_alpha())
game_over_rectangle = game_over_surface.get_rect(center = (288,512))

flap_sound = pygame.mixer.Sound('flappybird/sound/sfx_wing.wav')
death_sound = pygame.mixer.Sound('flappybird/sound/sfx_hit.wav')
score_sound = pygame.mixer.Sound('flappybird/sound/sfx_point.wav')
